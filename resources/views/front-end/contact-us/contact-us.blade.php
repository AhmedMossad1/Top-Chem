        ...
        <div class="col-md-8 ml-auto mr-auto">
            ...
            <div class="row">
                ...
                <div class="input-group">
                    ...
                    <input type="text" @error($input) is-invalid @enderror name="{{$input}}" class="form-control" placeholder="Name">
                    @error($input)
                        <span  role="alert">
                ...
                <div class="input-group">
                    ...
                    <input type="text" @error($input) is-invalid @enderror name="{{$input}}" class="form-control" placeholder="Email">
                    @error($input)
                    <span  role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
