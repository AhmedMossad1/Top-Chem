...
class DashboardController extends Controller
{
    ...
    public function index(){
        ...
        return view('Dashboard.'.$this->getClassNameFromModel().'.index',compact(
            'rows',
            'moduleName',
            'pageDes',
            'pageTitle',
    ...
    public function create(){
        ...
        $append=$this->append();
        return view('Dashboard.'.$folderName.'.create',compact(
            'routeName',
            'pageTitle',
            'pageDes',
            'moduleName',
    ...
    public function edit($id){
        ...
        $routeName = $folderName;
        $append=$this->append();
        return  view('Dashboard.' . $folderName . '.edit', compact(
            'row',
            'pageTitle',
            'moduleName',
            'pageDes',
